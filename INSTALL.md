# Building and Installing the Crossplane argocd Provider

`provider-argocd` is composed of a golang project and can be built directly with
...
You can build the Crossplane argocd Provider for the host platform by
