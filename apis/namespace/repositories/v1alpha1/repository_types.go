...
//go:generate sed -i s|v2\.Reference|v2.NamespacedReference|g zz_generated.repository_types.copied.go
//go:generate sed -i s|v2\.Selector|v2.NamespacedSelector|g zz_generated.repository_types.copied.go
